...
<table style="border-collapse:none;" width="990px"  >
	<tr>
		<td width="250px" ><b style="color:red;font-size:20px" >Sản phẩm được đặt hàng </b><br><br> </td>	
		<td width="740px" align="right" >
			<a href="<?php echo $link_dong; ?>"  style="margin-right:30px" >Đóng</a>
		</td>		
	</tr>
	<tr>
		<td align="left" colspan="2" >
			<table style="border-collapse:none;" width="880px" >
				<tr>
					...
					for($i=0;$i<count($m);$i++)
					{
						if(isset($m[$i]))
						{
							if($m[$i]!="")
							{
								...
								$tv_sp_1=mysqli_query($mysqli,$tv_sp);
...
<table style="border-collapse:none;" width="990px" >
	<tr>
		<td width="180px" ><b style="color:red;font-size:20px" >Thông tin người mua</b><br><br> </td>
